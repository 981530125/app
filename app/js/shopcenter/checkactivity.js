...
$(function(){
	...
	var rootpower = [{
			obj:'.returnbtn',
			apiurl:'/index.php/Api/Apps/Jingkaiqu/Shop_activity/editShopActivity'
		}];
	window.picimg = [];
//	修改信息,获取数据
	mui.plusReady(function() {
        var self = plus.webview.currentWebview();
        var item_info = self.item_info;
        item_info.rooturl = rooturl;
...
//添加编辑上传活动
	function editactivity(formjson,activity_file_ids){

		var url = rooturl+'index.php/Api/Apps/Jingkaiqu/Shop_activity/editShopActivity';
		$.ajax({
			type: "post",
			url: url,
			async: true,
			data: {
				...
				id:formjson.id,
				start_at:formjson.start_at,
				end_at:formjson.end_at,
				content:formjson.content,
				activity_file_ids:activity_file_ids,
				name:formjson.name,
				is_release:formjson.is_release,
				review_status:formjson.review_status,
				review_content:formjson.review_content,
				loginway:loginway
			},
			dataType: 'json',
...
//	删除活动
	function deleteactivitybyid(id){
		var url = rooturl+'index.php/Api/Apps/Jingkaiqu/Shop_activity/deleteData';
		$.ajax({
			type: "post",
			url: url,
			async: true,
...
//点击添加图片
	...
	//服务端接口路径
	var server = rooturl + "index.php/Api/Apps/Jingkaiqu/Shop_activity_file/upload";
	//获取图片元素
