...
//			暂无信息
	...
	$('html').on('click','.search-btn',function(){
		...
		activity(type_id,searchkey,is_release,0);
	})
...
//	点击查看详情
	...
	function activity(review_status,searchkey,is_release,pullup){
		console.log(clientId);
		console.log(accessToken);
		var url = rooturl+'index.php/Api/Apps/Jingkaiqu/Shop_activity/getShopActivity';
		$.ajax({
			type: "post",
			url: url,
			async: true,
