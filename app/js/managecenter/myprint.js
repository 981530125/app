$(function(){
	console.log('2222');
	$('html').on('click','#bt1',function(){
		searchDevices('a');
	})
	
	$('html').on('click','.addprint',function(){
	            ...
	            if (BleDevice.getBondState() == bdevice.BOND_NONE) {
	                ...
	                if (address == BleDevice.getAddress()) {
	                    if (BleDevice.createBond()) { //配对命令.createBond()
	                        ...
	                        li2.setAttribute('class','addprint');
	                        li2.setAttribute('data-id', BleDevice.getAddress()); //打印机mac地址
//	                        li2.setAttribute('onclick', 'print(id)'); //注册click点击列表进行打印
	                    ...
	                    if(BleDevice.getName() != on ){ //判断防止重复添加
		                    ...
		                    li1.style.height = '30px';
		                    li1.style.width = '100%';
		                   	li1.style.border = '1px solid #000';
	                ...
	                var li2 = document.createElement('li'); //注册
	                li2.style.height = '100px';
	                li2.style.width = '100%';
	                li2.style.border = '1px solid #000';
