       ...
       var marker = new qq.maps.Label({
		...
		for(var m = 0;m<shopinfo.length;m++){
			...
			var marker = new qq.maps.Marker({
	           ...
	           //地址为设置
//	        if(shopinfo[m].corporation_address){
//	        	var address = shopinfo[m].corporation_address;
//	        }else{
//	        	var address = shopinfo[m].licenses;
//	        }
	        markers.push(marker);
		}
			...
			(function(n){
	            qq.maps.event.addListener(markers[n], 'click', function() {
					...
					infoWin.setContent('<div style="text-align:center;white-space:' +
								'nowrap;margin:10px;font-size: 14px;"> ' + corporation_name+ ' </div>');
					//提示窗位置
