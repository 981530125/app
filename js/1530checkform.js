...
//						userResult.innerText = items[0].text;
						...
						userPicker.hide();
						var mode = '<div class="mui-collapse-content" style="border-top: 1px solid #cccccc;"><p class="openform" data-enname="'+en_name+'">'+items[0].text+'</p></div>'
						 console.log(mode);
